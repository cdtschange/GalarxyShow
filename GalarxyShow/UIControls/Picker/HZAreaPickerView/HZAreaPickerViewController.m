...
@interface HZAreaPickerViewController ()

@end

@implementation HZAreaPickerViewController
@synthesize areaText;
@synthesize cityText;
...
- (BOOL)textFieldShouldBeginEditing:(UITextField *)textField
{
    if ([textField isEqual:self.areaText]) {
        ...
        CGRect frame = self.locatePicker.frame;
        frame.size.width = self.view.frame.size.width;
        self.locatePicker.frame = frame;
