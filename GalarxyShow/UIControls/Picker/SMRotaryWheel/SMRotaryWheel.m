...
- (void) drawWheel {
    ...
    for (int i = 0; i < numberOfSections; i++) {
        ...
        UIImageView *im = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"smrotary_segment.png"]];
        ...
        cloveImage.image = [UIImage imageNamed:[NSString stringWithFormat:@"smrotary_icon%i.png", i]];
    ...
    bg.image = [UIImage imageNamed:@"smrotary_bg.png"];
    [self addSubview:bg];
    
    UIImageView *mask = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 58, 58)];
    mask.image =[UIImage imageNamed:@"smrotary_centerButton.png"] ;
