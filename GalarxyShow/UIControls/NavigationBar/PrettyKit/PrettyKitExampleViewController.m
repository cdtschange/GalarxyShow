...
@implementation PrettyKitExampleViewController
...
{
	PrettyKitModalViewController *modalView = [[PrettyKitModalViewController alloc] initWithNibName:@"PrettyKitModalViewController" bundle:nil];
