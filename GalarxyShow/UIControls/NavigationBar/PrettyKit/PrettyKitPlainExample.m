...
#import <GalarxyUIKitLib/PrettyKit.h>


#define start_color [UIColor colorWithHex:0xEEEEEE]
#define end_color [UIColor colorWithHex:0xDEDEDE]

@implementation PrettyKitPlainExample
...
- (void)viewDidLoad
{
    ...
    self.ctableView.rowHeight = 60;
    self.ctableView.separatorStyle = UITableViewCellSeparatorStyleNone;
    self.ctableView.backgroundColor = [UIColor scrollViewTexturedBackgroundColor];
...
{
    [self.ctableView deselectRowAtIndexPath:indexPath animated:YES];
}
