...
@implementation UAModalExamplePanel
...
- (id)initWithFrame:(CGRect)frame title:(NSString *)title {
	if ((self = [super initWithFrame:frame])) {
		...
		[iv setImage:[UIImage imageNamed:@"uamodal_UrbanApps.png"]];
		[iv setContentMode:UIViewContentModeScaleAspectFit];
		
		[[NSBundle mainBundle] loadNibNamed:@"UAModalExamplePanel" owner:self options:nil];
