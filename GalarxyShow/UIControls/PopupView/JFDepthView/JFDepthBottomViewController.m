...
#import "JFDepthBottomViewController.h"
#import "JFDepthTopViewController.h"

@interface JFDepthBottomViewController ()
@property (nonatomic, strong) JFDepthView* depthView;
@property (nonatomic, strong) JFDepthTopViewController* topViewController;
@end

@implementation JFDepthBottomViewController
...
- (void)viewDidLoad
{
    ...
    self.topViewController = [[JFDepthTopViewController alloc] initWithNibName:@"JFDepthTopViewController" bundle:nil];
