...
#import "FPPopoverViewController.h"
#import "FPPopoverDemoTableController.h"

@interface FPPopoverViewController ()

@end

@implementation FPPopoverViewController
...
-(void)popover:(id)sender
{
    ...
    FPPopoverDemoTableController *controller = [[FPPopoverDemoTableController alloc] initWithStyle:UITableViewStylePlain];
