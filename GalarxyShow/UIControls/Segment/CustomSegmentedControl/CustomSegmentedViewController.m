...
@interface CustomSegmentedViewController (){
    NSArray* buttons;
}
...
- (void)viewDidLoad
{
    ...
    buttons = [NSArray arrayWithObjects:
                [NSDictionary dictionaryWithObjectsAndKeys:[NSArray arrayWithObjects:@"One", @"Two", @"Three", nil], @"titles", [NSValue valueWithCGSize:CGSizeMake(80,47)], @"size", @"customseg_bottombarblue.png", @"button-image", @"customseg_bottombarblue_pressed.png", @"button-highlight-image", @"customseg_blue-divider.png", @"divider-image", [NSNumber numberWithFloat:14.0], @"cap-width", nil],
                [NSDictionary dictionaryWithObjectsAndKeys:[NSArray arrayWithObjects:@"One", @"Two", nil], @"titles", [NSValue valueWithCGSize:CGSizeMake(80,47)], @"size", @"customseg_bottombarblue.png", @"button-image", @"customseg_bottombarblue_pressed.png", @"button-highlight-image", @"customseg_blue-divider.png", @"divider-image", [NSNumber numberWithFloat:14.0], @"cap-width", nil],
                [NSDictionary dictionaryWithObjectsAndKeys:[NSArray arrayWithObjects:@"One", @"Two", @"Three", nil], @"titles", [NSValue valueWithCGSize:CGSizeMake(100,47)], @"size", @"customseg_bottombarredfire.png", @"button-image", @"customseg_bottombarredfire_pressed.png", @"button-highlight-image", @"customseg_red-divider.png", @"divider-image", [NSNumber numberWithFloat:14.0], @"cap-width", nil],
                [NSDictionary dictionaryWithObjectsAndKeys:[NSArray arrayWithObjects:@"1", @"2", nil], @"titles", [NSValue valueWithCGSize:CGSizeMake(47,47)], @"size", @"customseg_bottombarredfire.png", @"button-image", @"customseg_bottombarredfire_pressed.png", @"button-highlight-image", @"customseg_red-divider.png", @"divider-image", [NSNumber numberWithFloat:14.0], @"cap-width", nil], nil];
...
-(void)addView:(UIView*)subView verticalOffset:(NSUInteger)verticalOffset title:(NSString*)title
{
    ...
    // Add a label
    UILabel* label = [[UILabel alloc] initWithFrame:CGRectMake(HORIZONTAL_OFFSET, elementVerticalLocation + VERTICAL_OFFSET, 0, 0)];
