...
@implementation ASIDemoRequestProgressCell

+ (id)cell
{
	ASIDemoRequestProgressCell *cell = [[[ASIDemoRequestProgressCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:@"ASIDemoRequestProgressCell"] autorelease];
