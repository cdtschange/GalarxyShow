...
@implementation ASIDemoInfoCell

+ (id)cell
{
	ASIDemoInfoCell *cell = [[[ASIDemoInfoCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"ASIDemoInfoCell"] autorelease];
