...
#import <GalarxyFoundationLib/ASINetworkQueue.h>
#import "ASIDemoInfoCell.h"
#import "ASIDemoToggleCell.h"

// Private stuff
@interface ASIDemoQueueViewController ()
- (void)imageFetchComplete:(ASIHTTPRequest *)request;
- (void)imageFetchFailed:(ASIHTTPRequest *)request;
@end

@implementation ASIDemoQueueViewController
...
- (UITableViewCell *)tableView:(UITableView *)theTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if ([indexPath section] == 0) {
		...
		accurateProgress = [(ASIDemoToggleCell *)cell toggle];
		
	} else {
		
		cell = [theTableView dequeueReusableCellWithIdentifier:@"ImagesCell"];
