...
#import <GalarxyFoundationLib/ASIFormDataRequest.h>
#import "ASIDemoInfoCell.h"

// Private stuff
@interface ASIDemoUploadViewController ()
- (void)uploadFailed:(ASIHTTPRequest *)theRequest;
- (void)uploadFinished:(ASIHTTPRequest *)theRequest;
@end

@implementation ASIDemoUploadViewController
...
{
	[super viewDidLoad];
	[self setTitle:@"Tracking Upload Progress"];
...
- (UITableViewCell *)tableView:(UITableView *)theTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if ([indexPath section] == 0) {
		cell = [theTableView dequeueReusableCellWithIdentifier:@"ASIDemoInfoCell"];
		if (!cell) {
