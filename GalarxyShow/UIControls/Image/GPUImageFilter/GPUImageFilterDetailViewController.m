//
//  GPUImageFilterCameraDetailViewController.m
//  GalarxyShow
//
...
#import "GPUImageFilterDetailViewController.h"
#import <CoreImage/CoreImage.h>

@interface GPUImageFilterDetailViewController ()

@end

@implementation GPUImageFilterDetailViewController
@synthesize faceDetector;
@synthesize isCamera;

- (id)initWithFilterType:(GPUImageShowcaseFilterType)newFilterType;
{
    self = [super initWithNibName:@"GPUImageFilterDetailViewController" bundle:nil];
    if (self)
    {
...
- (void)setupFilter;
{
    if (isCamera) {
        ...
        UIImage *image = [UIImage imageNamed:@"gpufilter_WID-small.jpg"];
    ...
    switch (filterType)
    {
        ...
        case GPUIMAGE_VORONI:
        {
            ...
            sourcePicture = [[GPUImagePicture alloc] initWithImage:[UIImage imageNamed:@"gpufilter_voroni_points2.png"]];
        ...
        case GPUIMAGE_MOSAIC:
        {
            ...
            [(GPUImageMosaicFilter *)filter setTileSet:@"gpufilter_squares.png"];
            [(GPUImageMosaicFilter *)filter setColorOn:NO];
            //[(GPUImageMosaicFilter *)filter setTileSet:@"gpufilter_dotletterstiles.png"];
            //[(GPUImageMosaicFilter *)filter setTileSet:@"gpufilter_curvies.png"];
    ...
    if (filterType == GPUIMAGE_FILECONFIG)
    {
        ...
        if (isCamera) {
            pipeline = [[GPUImageFilterPipeline alloc] initWithConfigurationFile:[[NSBundle mainBundle] URLForResource:@"GPUImageFilterConfiguration" withExtension:@"plist"]
    ...
    else
    {
        ...
        if (needsSecondImage)
        {
			...
			{
				inputImage = [UIImage imageNamed:@"gpufilter_mask"];
			}
            /*
             ...
             inputImage = [UIImage imageNamed:@"voroni_points.png"];
				...
				inputImage = [UIImage imageNamed:@"gpufilter_WID-small.jpg"];
			}
        ...
        else if ( (filterType == GPUIMAGE_SPHEREREFRACTION) || (filterType == GPUIMAGE_GLASSSPHERE) )
        {
            ...
            if (isCamera) {
                ...
                [sourcePicture addTarget:gaussianBlur];
            }
