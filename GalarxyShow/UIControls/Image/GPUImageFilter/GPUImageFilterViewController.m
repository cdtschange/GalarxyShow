//
//  GPUImageFilterCameraViewController.m
//  GalarxyShow
//
...
- (void)viewDidLoad
{
    ...
    _segmentedControl = [[UISegmentedControl alloc] initWithItems:[NSArray arrayWithObjects:@"Camera", @"Image", nil]];
...
- (void)segmentChange {
    isCamera = _segmentedControl.selectedSegmentIndex==0;
}
...
{
    GPUImageFilterDetailViewController *filterViewController = [[GPUImageFilterDetailViewController alloc] initWithFilterType:indexPath.row];
    filterViewController.isCamera = isCamera;
