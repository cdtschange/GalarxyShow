...
#import "BJCropImageViewController.h"
...
@implementation BJCropImageViewController
...
- (void)viewDidLoad
{
    ...
    self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"bjcrop_tactile_noise.png"]];
    
    self.imageCropper = [[BJImageCropper alloc] initWithImage:[UIImage imageNamed:@"bjcrop_gavandme.jpg"] andMaxSize:CGSizeMake(1024, 600)];
