...
#import "SMTransformViewController.h"
#import <GalarxyUIKitLib/SMShadowedLayer.h>
#import <GalarxyUIKitLib/SMTransformLayer.h>

@interface SMTransformViewController ()
{
...
@implementation SMTransformViewController
...
- (void)viewWillAppear:(BOOL)animated
{
	...
	UIImage *image = [UIImage imageNamed:@"smtransform_periwinkle"];
