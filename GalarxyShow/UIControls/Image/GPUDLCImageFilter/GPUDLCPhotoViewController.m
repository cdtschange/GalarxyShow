...
#import "GPUDLCPhotoViewController.h"
#import <AssetsLibrary/AssetsLibrary.h>

@interface GPUDLCPhotoViewController ()

@end

@implementation GPUDLCPhotoViewController
...
-(void) takePhoto:(id)sender{
    GPUDLCImageFilterViewController *picker = [[GPUDLCImageFilterViewController alloc] init];
