...
#import <GalarxyUIKitLib/TPCircularBuffer.h>
#import <GalarxyUIKitLib/SNFCoreAudioUtils.h>

// example file for fileplayer
// file needs to be in resources/sounds folder

#define FILE_PLAYER_FILE @"dmxbeat"
...
static void	MyMIDIReadProc(const MIDIPacketList *pktlist, void *refCon, void *connRefCon) {
	MixerHostAudio *myVC = ( MixerHostAudio *) refCon;
