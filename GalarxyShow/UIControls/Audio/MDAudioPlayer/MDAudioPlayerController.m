...
//	[[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleBlackOpaque animated:YES];
	...
	self.titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(512-195/2.0, 14, 195, 12)];
	...
	self.artistLabel = [[UILabel alloc] initWithFrame:CGRectMake(512-195/2.0, 2, 195, 12)];
	...
	self.albumLabel = [[UILabel alloc] initWithFrame:CGRectMake(512-195/2.0, 27, 195, 12)];
	...
	self.containerView = [[UIView alloc] initWithFrame:CGRectMake(512-160, 44,320, self.view.bounds.size.height - 44)];
	...
	self.songTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, 320, 368)];
	...
	UIImageView *buttonBackground = [[UIImageView alloc] initWithFrame:CGRectMake(512-160, 44 + 320, 320, 96)];
	...
	self.playButton = [[UIButton alloc] initWithFrame:CGRectMake(144+512-160, 370, 40, 40)];
	...
	self.pauseButton = [[UIButton alloc] initWithFrame:CGRectMake(140+512-160, 370, 40, 40)];
	...
	self.nextButton = [[UIButton alloc] initWithFrame:CGRectMake(220+512-160, 370, 40, 40)];
	...
	self.previousButton = [[UIButton alloc] initWithFrame:CGRectMake(60+512-160, 370, 40, 40)];
	...
	self.volumeSlider = [[UISlider alloc] initWithFrame:CGRectMake(25+512-160, 420, 270, 9)];
...
CGImageRef MDCreateGradientImage(int pixelsWide, int pixelsHigh)
{
...
CGContextRef MDMyCreateBitmapContext(int pixelsWide, int pixelsHigh)
{
...
- (UIImage *)reflectedImage:(UIButton *)fromImage withHeight:(NSUInteger)height
{
	...
	CGContextRef mainViewContentContext = MDMyCreateBitmapContext(fromImage.bounds.size.width, height);
	
	CGImageRef gradientMaskImage = MDCreateGradientImage(1, height);
