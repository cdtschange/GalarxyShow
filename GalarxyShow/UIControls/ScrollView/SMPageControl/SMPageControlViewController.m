...
#import <GalarxyUIKitLib/SMPageControl.h>

@interface SMPageControlViewController ()
...
{
    [super viewDidLoad];
	self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"smpage_retro_intro"]];
	...
	[self.spacePageControl4 setPageIndicatorImage:[UIImage imageNamed:@"smpage_pageDot"]];
	[self.spacePageControl4 setCurrentPageIndicatorImage:[UIImage imageNamed:@"smpage_currentPageDot"]];

	[self.spacePageControl5 setPageIndicatorImage:[UIImage imageNamed:@"smpage_pageDot"]];
	[self.spacePageControl5 setCurrentPageIndicatorImage:[UIImage imageNamed:@"smpage_currentPageDot"]];
	[self.spacePageControl5 setImage:[UIImage imageNamed:@"smpage_searchDot"] forPage:0];
	[self.spacePageControl5 setCurrentImage:[UIImage imageNamed:@"smpage_currentSearchDot"] forPage:0];
	[self.spacePageControl5 setImage:[UIImage imageNamed:@"smpage_appleDot"] forPage:1];
	[self.spacePageControl5 setCurrentImage:[UIImage imageNamed:@"smpage_currentAppleDot"] forPage:1];
	self.spacePageControl5.currentPage = 3;
	
	[self.spacePageControl6 setPageIndicatorImage:[UIImage imageNamed:@"smpage_pageDot"]];
	[self.spacePageControl6 setCurrentPageIndicatorImage:[UIImage imageNamed:@"smpage_currentPageDot"]];
	[self.spacePageControl6 setImage:[UIImage imageNamed:@"smpage_searchDot"] forPage:0];
	[self.spacePageControl6 setCurrentImage:[UIImage imageNamed:@"smpage_currentSearchDot"] forPage:0];
	[self.spacePageControl6 setImage:[UIImage imageNamed:@"smpage_appleDot"] forPage:1];
	[self.spacePageControl6 setCurrentImage:[UIImage imageNamed:@"smpage_currentAppleDot"] forPage:1];
