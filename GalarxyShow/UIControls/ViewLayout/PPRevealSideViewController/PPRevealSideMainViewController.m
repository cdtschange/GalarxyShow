...
@implementation PPRevealSideMainViewController
...
- (void) preloadLeft {
    PPRevealSideTableViewController *c = [[PPRevealSideTableViewController alloc] initWithStyle:UITableViewStylePlain];
...
- (void) showRight {
    PPRevealSidePopedViewController *c = [[PPRevealSidePopedViewController alloc] initWithNibName:@"PPRevealSidePopedViewController" bundle:nil ];
