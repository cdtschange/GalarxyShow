...
#import "TouchPieMenuViewController.h"
#import <GalarxyUIKitLib/PieMenu.h>

@interface TouchPieMenuViewController (PrivateMethods)

- (void) itemSelected:(PieMenuItem *)item;

@end

@implementation TouchPieMenuViewController
...
- (void)viewDidLoad {
	...
	PieMenuItem *itemA = [[PieMenuItem alloc] initWithTitle:@"ItemA"
												   ...
												   userInfo:nil
													   icon:[UIImage imageNamed:@"touchpie_icon1.png"]];
	...
	PieMenuItem *itemC = [[PieMenuItem alloc] initWithTitle:@"ItemC"
												   ...
												   selector:@selector(itemSelected:)
												   userInfo:nil
													   icon:[UIImage imageNamed:@"touchpie_icon2.png"]];
	...
	PieMenuItem *itemD = [[PieMenuItem alloc] initWithTitle:@"ItemD"
												   ...
												   selector:@selector(itemSelected:)
												   userInfo:nil
													   icon:[UIImage imageNamed:@"touchpie_icon3.png"]];
	...
	PieMenuItem *itemE = [[PieMenuItem alloc] initWithTitle:@"ItemE"
												   ...
												   selector:@selector(itemSelected:)
												   userInfo:nil
													   icon:[UIImage imageNamed:@"touchpie_icon4.png"]];
