...
#import "AMProgressViewController.h"
#import <GalarxyUIKitLib/AMProgressView.h>

@interface AMProgressViewController ()

@end

@implementation AMProgressViewController
