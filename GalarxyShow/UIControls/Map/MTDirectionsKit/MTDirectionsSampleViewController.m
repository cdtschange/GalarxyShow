...
#import <GalarxyUIKitLib/HRColorPickerViewController.h> // Color Picker from https://github.com/hayashi311/Color-Picker-for-iOS
#import <GalarxyUIKitLib/MTDSampleRequest.h>
#import <GalarxyUIKitLib/MTDSampleParser.h>
#import <GalarxyUIKitLib/MTDManeuverTableViewController.h>
...
- (void)setupUI {
    ...
    self.segmentedControl = [[UISegmentedControl alloc] initWithItems:@[[UIImage imageNamed:@"mtdirect_pedestrian"],
                             [UIImage imageNamed:@"mtdirect_bicycle"],
                             [UIImage imageNamed:@"mtdirect_car"]]];
