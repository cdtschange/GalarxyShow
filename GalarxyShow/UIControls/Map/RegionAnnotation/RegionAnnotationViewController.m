...
#import "RegionAnnotationViewController.h"

@interface RegionAnnotationViewController () <RCLocationManagerDelegate, MKMapViewDelegate>
{
...
@implementation RegionAnnotationViewController
...
//    
    ...
    // Create location manager with filters set for battery efficiency.
    locationManager = [RCLocationManager sharedManager];
